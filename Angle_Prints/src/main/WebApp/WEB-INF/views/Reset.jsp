  ...
  <div class="wrapper">
    <form action="/reset">
      ...
      <div class="input-box">
        ...
        <input type="password" id="oldPassword" placeholder="EntrerOld Password" name="oldPwd"  required >
      </div>
      <div class="input-box">
      
        <input type="password"  id="newPassword" placeholder="EntrerNew Password" name="newPwd"  required oninput="checkNewandOldPasswordsMatch()">
